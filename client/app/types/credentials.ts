...
export const SERVICE_DEFINITIONS: ServiceDefinition[] = [
  ...
  ,
  {
    ...
    fields: [
      ...
      { name: 'database', label: 'Database', type: 'text', required: false, placeholder: 'kai_demo', description: 'Default database used by the connection' },
      ...
      { name: 'ssh_password', label: 'SSH Password', type: 'password', required: false, dependsOn: { field: 'ssh_authenticate_with', values: ['password'] } },
      { name: 'ssh_private_key', label: 'SSH Private Key', type: 'textarea', required: false, dependsOn: { field: 'ssh_authenticate_with', values: ['private_key'] } },
      { name: 'ssh_passphrase', label: 'SSH Key Passphrase', type: 'password', required: false, dependsOn: { field: 'ssh_authenticate_with', values: ['private_key'] } }
    ]
  }
];
