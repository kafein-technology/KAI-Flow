                ...
                return (
                  <div key={property.name} className="relative col-span-2">
                    ...
                    <button
                      ...
                      className="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs z-10 transition-colors"
