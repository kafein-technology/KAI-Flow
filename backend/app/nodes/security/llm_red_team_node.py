...
ATTACK_MAP = {
    ...
    "ROT13": ("ROT13", "single"), "Base64": ("Base64", "single"), "Leetspeak": ("Leetspeak", "single"),
    ...
    def _build_properties(self) -> List[NodeProperty]:
        return [
            ...
            NodeProperty(name="attacks", displayName="Attack Vectors",
                         ...
                         hint="Comma-separated. Supports Jinja: ${{ webhook_trigger.attacks }}. E.g: Prompt Injection, Jailbreaking, ROT13, Base64",
                         required=True),
