...
class DatabaseSetup:
    ...
    async def setup_database(self, force: bool = False, check_only: bool = False, drop_all: bool = False,
        ...
        if check_only:
            ...
            self._logger_validation_results(validation)
            return True
        ...
        if validation["missing_tables"] or force:
            ...
            self._logger_validation_results(post_validation)
        ...
        if sync_columns and validation["column_issues"]:
            ...
            self._logger_validation_results(final_validation)
    ...
    def _logger_validation_results(self, validation: Dict[str, Any]):
